...
export default function Home() {
  return (
    <>
      ...
      <section>
        <Image src={mainBanner} alt="Digimon" />
      </section>
      <section className="bg-white py-8">
        <div className="bay-container mx-auto flex flex-wrap items-center pb-12 pt-4">
          <nav id="store" className="top-0 z-30 w-full px-6 py-1">
            <div className="bay-container mx-auto mt-0 flex w-full flex-wrap items-center justify-between px-2 py-3">
              <a
      ...
      <section className="bg-white py-8">
        <div className="bay-container mx-auto px-6 py-8">
          <a
            className="mb-8 text-xl font-bold uppercase tracking-wide text-gray-800 no-underline hover:no-underline"
            href="#"
          >
            About
          </a>
      ...
      <footer className="bay-container mx-auto border-t border-gray-400 bg-white py-8">
        <div className="bay-container flex px-3 py-8 ">
